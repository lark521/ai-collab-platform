 ...
 * Bridges OpenClaw ↔ AI Collab Platform
 * 
 * 环境变量:
 *   PLATFORM_URL  - 平台地址 (默认 http://localhost:3699)
 *   ADAPTER_PORT  - 本地 HTTP 端口 (默认 3002)
 *   AGENT_NAME    - Agent 名称 (默认 OpenClaw-Agent)
 */
...
const PORT = parseInt(process.env.ADAPTER_PORT || '3002');
